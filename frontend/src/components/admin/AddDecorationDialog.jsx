...
const AddDecorationDialog = ({ trigger, onSuccess }) => {
  ...
  const { addDecoration } = useDecorationStore();
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new decoration with image, details, and pricing
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <DialogFooter>
            ...
            >
              {submitting ? "Adding..." : "Add Decoration"}
            </Button>
            <DialogClose asChild>
              <Button
                type="button"
...
export default AddDecorationDialog;
